...
# ---- 团队头像 (200x200) ----
make_svg("team1.jpg", 200, 200, "#1a2a4a", "#2c4a7c", "田中老师", "👩‍🏫")
make_svg("team2.jpg", 200, 200, "#c9a84c", "#d4b85c", "王老师",   "👨‍🏫")
make_svg("team3.jpg", 200, 200, "#2c4a7c", "#4a7ab0", "佐藤老师", "👩‍🏫")
make_svg("team4.jpg", 200, 200, "#e8857a", "#f7a8b8", "李老师",   "👨‍🏫")

# ---- 关于我们 - 办公环境 (800x400) ----
make_svg("about_office.jpg", 800, 400, "#1a2a4a", "#c9a84c", "樱路留学办公环境", "🏢")
